...
•	Esitasime tabeli oma teenustega. Kas olete selle läbi analüüsinud? Oli raskusi ministeeriumi tasandil teenuseid kirjeldada. Mis te soovitate?
Lisada Andrease vaade. 

•	Vajalik on ühise arusaamise kujundamine. Kas on plaanis teha erisustega asutustele erisusega lähenemine (teaduse seotud teenused nt laboriteenused või nt muuseumid)? 
Hetkel plaanis ei ole. Hiljem, kui tekib ülevaade erisustest võib seda kaaluda.

•	Palun olge nii kena ning kommenteerige MKM-i plaani seoses loodava koostöövõrgustikuga. Täpsemalt, kuidas peaks käsitlema selle raames ministeeriumi valitsemisala allasutuste avalike teenuste koordinaatoreid juhul, kui on otsustatud ka allasutustes omad koordinaatorid määrata? Teisisõnu kas koostöövõrgustikus saab osalema üksnes ministeeriumi tasandi peakoordinaator või ka allasutuste koordinaatorid juhul, kui nad on määratud?
...
•	Millal saame kätte definitsioonid teenusele, e-teenusele, avalikule teenusele?
...
•	Kas jagate kuskil ka teenuste kataloogiga seonduvaid materjale ning kas kuskil näeb ülevaadet tehtud muudatusettepanekutest?

Viide githubile. Eraldi link veel githubis „issues“.


##E-teenuste kirjeldamine

•	Kas see vaade sobib kõigile asutustele?
Jah, sobib küll.

•	Kui teenus on üks, aga erinevaid osad on erinevates kanalites, kuidas seda üles märkida?
...
•	Hästi palju on sellist teenust nagu kooskõlastus. Kuidas seda kaardistada?	 
...
Saada kiri riigiteenused@mkm.ee või lisa see Githubi, issues
•	Kas teenuste sisestajatel peab olema kindlasti igal sisestajal oma konto või võib asutuses sisestada oma teenuseid ühe konto alt mitu erinevat kasutajat?
Soovime, et iga kasutaja taga on konkreetne inimene. 
•	Kas kasutajad loote automaatselt?
...
•	Kuidas klassifitseerida selliseid ametnikke, näiteks notarid, kes on kahe sihtgrupi vahel (ettevõtja/ametnik)?
...
•	Kuidas jääb kahe infosüsteemi vaheliste andmete vahetamisega? Kas see on teenus?
Meie jaoks on teenus siis, kui mina kliendina saan seda teenust minna taotlema. 

•	Kus leiab riigiteenused.ee-sse sisestatav informatsioon kasutust? Mis MKM teeb selle infoga?
...
•	Kas ma pean kirja panema kõik kanalid? Kas võin kirja panna vaid prioriteetsemad kanalid?
...
Sel juhul on ok. 
•	Mis on MKM-i ootus, kui tihti peaks infot teenuste kataloogis Update’ima?
...
Üldkoordinaatori rolli peaks täitma vastavalt kas (ase)kantslerite, (ase)direktorite tasand, või osakonnajuhatajate tasand tingimusel, et osakonna juhatajal hakkab olema õigus osutatavate teenuste kvaliteedi osas juhtkonna tasandil ettepanekuid tegema ning otsuseid vastu võtma.
...
Majandustegevuse registri kui infoteenuse teenuse kirjeldus teenuste kataloogis (teenus isikule ja ettevõtjale):  
https://www.mkm.ee/et/teenuste-otsing?title-search=registreering&field_t_kirjeldus_value=&sort_by=field_t_osutatud_teenuste_arv_value&=Otsi 
2)	Teenuste kataloog, teenus ametnikele (teenuste omanikud) ja teenuste kohta info otsijatele (kliendid).
2.1	nn teenuste omanike tööriist, mille vahendusel saab kaardistada teenused veebipõhises rakenduses. Teenus on suunatud ametitele, inspektsioonidele ja ministeeriumitele.
Teenuste kirjeldamine teenuste kataloogis (teenus ametnike): https://www.mkm.ee/et/teenuste-otsing/t?title-search=Teenuste+kirjeldamine&field_t_kirjeldus_value=&sort_by=field_t_osutatud_teenuste_arv_value&=Otsi  
2.2	Teenuste kataloog, teenuste otsing (teenus kodanikule ja ettevõtjale) https://www.mkm.ee/et/teenuste-otsing?title-search=otsida+informatsiooni&field_t_kirjeldus_value=&sort_by=field_t_osutatud_teenuste_arv_value&=Otsi 
...
Läänemere strateegia programmi kirjeldus teenuste kataloogis:
https://www.mkm.ee/et/teenuste-otsing?title-search=l%C3%A4%C3%A4nemere&field_t_kirjeldus_value=&sort_by=field_t_osutatud_teenuste_arv_value&=Otsi 
...
•	Kuidas soovite korraldada valitsemisala allasutustel teenuste omanike määramisel tekkida võivate küsimustele vastamise? 

Küsimusteks ja ettepanekuteks on loodud e-postkast riigiteenused@mkm.ee, mille vahendusel oleme nõus kõiki asjasse puutuvaid kolleege nõustama. GITHUb Igal juhul oleks teretulnud lähenemine, kus teenuse omanik, küsides küsimust nimetatud e-posti vahendusel, eelnevalt oleks selle küsimuse üldvastutajaga läbiarutanud ning küsimuse saatmisel hoiaks üldvastutajat kirjavahetuses. Kirjade vahendajaks ja edasisaatjaks võib ka üldvastutaja olla, oluline on see, et info jõuaks kõikide asjasse puutuvate kolleegideni. 

•	Kas järelevalvelisi protsesse saab kajastada kui avalikku teenust? 

Järelevalvelisi tegevusi saab avaliku teenusena kirjeldada ja seda on ka tehtud juba. Näit TJA raudtee järelevalve.
https://www.mkm.ee/et/teenuste-otsing?title-search=raudtee+j%C3%A4relevalve&field_t_kirjeldus_value=&sort_by=field_t_osutatud_teenuste_arv_value&=Otsi
...
•	Palun kirjeldage, millisel kujul ja detailsus astmega võiks olla esitatud info teenuste omanikest (juhul, kui esimeses etapis on seda võimalik esitada). 
